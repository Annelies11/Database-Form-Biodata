...
public class Tampilan extends javax.swing.JFrame {
    ...
    private void TestKoneksi() {
        try {
            ...
            cn = DriverManager.getConnection("jdbc:mysql://localhost:3306/db_biodata2","root","");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        TestKoneksi();        // TODO add your handling code here:
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String id, nama, jk, kelas, email;
        ...
        try {
             ...
             st.executeUpdate("INSERT INTO biodata_siswa (id_bio, Nama, jk, kelas, email) VALUES ('"+id+"','"+nama+"','"+jk+"','"+kelas+"','"+email+"')");
             JOptionPane.showMessageDialog(null, "SUBMIT BERHASIL");
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "SUBMIT GAGAL\n" + e);
        }
